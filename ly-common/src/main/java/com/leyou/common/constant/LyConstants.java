...
public class LyConstants {
    ...
    /*用户收藏对象在redis中的key的前缀*/
    public static final String FAVORITE_PRE = "FAVORITE_PRE";

    /*支付链接在redis中存储的key的前缀*/
    public static final String PAY_URL_PRE = "PAY_URL_PRE";

    /* 定时过期的时间  20分钟*/
    public static final Integer TWENTY_MINUTE = 1200000;

    /* 定时过期的时间  2小时*/
    public static final Integer TWO_HOUR = 7200000;
}
