...
public interface ItemClient {
    ...
    public Void plusStock(@RequestBody Map<Long, Integer> plusMap);

    // 预减库存
    @PutMapping("/stock/predict")
    public Boolean predict(@RequestBody Map<Long, Integer> pdMap);

     /*根据skuId查询Spu*/
    @GetMapping("/spu/of/sku")
    public Spu findSpuBySkuId(@RequestParam("id") Long id);
